# Data Lake Connection module

Module to provision a Data Lake connection
...
module "data-lake-connection" {
  source = "github.com/Client-Engineering-Industry-Squad-1/terraform-data-lake-connection"
...
|------|-------------|---------|----------|--------|
| resource_group_name | The name of the Data Lake connection | true |  |  |
...
| Name | Description |
|------|-------------|
| name | The name of the Data Lake connection |
